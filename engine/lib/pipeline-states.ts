...
export const LABELS: Record<string, LabelDef> = {
  ...
  "source:code-health": {
    appliesTo: ["issue"],
    color: "0e8a16",
    description: "Findings from the automated code-health audit",
    stateMarker: true,
  },
  "agent:ready": {
    appliesTo: ["issue"],
    color: "1d76db",
    description: "Human-approved code-health finding, ready for an implementer agent to pick up",
    stateMarker: true,
  },
  "lens:naming": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the naming lens",
    stateMarker: true,
  },
  "lens:structure": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the structure lens",
    stateMarker: true,
  },
  "lens:types": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the types lens",
    stateMarker: true,
  },
  "lens:orientation": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the orientation lens",
    stateMarker: true,
  },
  "lens:verification": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the verification lens",
    stateMarker: true,
  },
  "lens:logging": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the logging lens",
    stateMarker: true,
  },
  "lens:assets": {
    appliesTo: ["issue"],
    color: "c5def5",
    description: "Code-health finding from the assets lens",
    stateMarker: true,
  },
  shft: {
    appliesTo: ["issue"],
